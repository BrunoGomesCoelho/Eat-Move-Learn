...
class HungryGeeseEnv(gym.Env):
    ...
    def __init__(self, dummy_env=False, opponent=['greedy','greedy-goose.py'], action_offset=1, debug=False, defaults=[7,11,10,2]):
...
env = HungryGeeseEnv(opponent=['greedy','greedy'], debug=False)
